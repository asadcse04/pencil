...
public class Income implements Serializable{
    ...
    public Income(int trnID, Date trnDate, String tranStatus, String tranName, double tranAmount, int trSubHeadID, String invoiceID, String paymentType, String attachedVoucherNo, String note, int bankID, String bankName, String checkNo, String userId) {
        this.trnID = trnID;
