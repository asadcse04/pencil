...
public class FeeHeadServiceImpl implements FeeHeadService {
    ...
    public boolean addFeeHead(FeeHead feeHead) 
    {
        ...
        try 
        {
            ...
            prst.setString(1, feeHead.getFeeHeadName());
            
            prst.setString(2, feeHead.getPrintName());
            
            prst.setString(3, feeHead.getNote());
            
            prst.setInt(4, feeHead.getFeeCategoryID());
    ...
    public List<FeeHead> getAllFeeHead() 
    {
       ...
       DB_Connection o = new DB_Connection();
        ...
        try {
            prst = con.prepareStatement("select * from student_fee_head");
